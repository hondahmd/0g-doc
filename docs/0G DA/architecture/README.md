...
In this way, 0G DA provides not only [security guarantee](../overview-1/) to the data but also efficiency for the user to quickly retrieve the data from the disperser.
